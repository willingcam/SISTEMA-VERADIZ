...
class TIIE28{
	...
	public function read(){
		...
		// select all query
		$query = " SELECT valor, fecha FROM  tiie28 ";
		...
		public function readPeriodo(){
			...
			// select all query
			$query = " SELECT valor, fecha FROM  tiie28 WHERE fecha BETWEEN '".$this->fechaInicio."' AND '".$this->fechaTermino."' ";
