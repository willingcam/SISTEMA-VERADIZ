<?php
class PreciosConsumidor{

	// database connection and table name
	private $conn;
	private $table_name = "precios_consumidor";
	...
	public function read(){
		...
		// select all query
		$query = "SELECT p.id, p.mes, p.anio, p.valor, p.tipoIndicador,  c.indicador FROM " . $this->table_name . " p  LEFT JOIN 	tipo_indicador c ON p.id = c.id  ";
