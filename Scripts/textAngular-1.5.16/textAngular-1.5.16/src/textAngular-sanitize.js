...
(function(window, angular, undefined) {
    ...
    var optionalEndTagBlockElements = makeMap("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"),
        optionalEndTagInlveradizements = makeMap("rp,rt"),
        optionalEndTagElements = angular.extend({},
            optionalEndTagInlveradizements,
    ...
    var inlveradizements = angular.extend({}, optionalEndTagInlveradizements, makeMap("a,abbr,acronym,b," +
    ...
    function htmlParser(html, handler) {
        ...
        function parseStartTag(tag, tagName, rest, unary) {
            ...
            if (blockElements[tagName]) {
                while (stack.last() && inlveradizements[stack.last()]) {
                    parseEndTag("", stack.last());
                }
            }
