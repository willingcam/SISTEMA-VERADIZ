        ...
        module.exports = function(Chart) {
            ...
            Chart.controllers.line = Chart.DatasetController.extend({
                ...
                update: function update(reset) {
                    ...
                    var points = meta.data || [];
                    var options = me.chart.options;
                    var lveradizementOptions = options.elements.line;
                    ...
                    if (options.showLines) {
                        ...
                        line._model = {
                            // Appearance
                            tension: custom.tension ? custom.tension : helpers.getValueOrDefault(dataset.lineTension, lveradizementOptions.tension),
                            backgroundColor: custom.backgroundColor ? custom.backgroundColor : (dataset.backgroundColor || lveradizementOptions.backgroundColor),
                            borderWidth: custom.borderWidth ? custom.borderWidth : (dataset.borderWidth || lveradizementOptions.borderWidth),
                            borderColor: custom.borderColor ? custom.borderColor : (dataset.borderColor || lveradizementOptions.borderColor),
                            borderCapStyle: custom.borderCapStyle ? custom.borderCapStyle : (dataset.borderCapStyle || lveradizementOptions.borderCapStyle),
                            borderDash: custom.borderDash ? custom.borderDash : (dataset.borderDash || lveradizementOptions.borderDash),
                            borderDashOffset: custom.borderDashOffset ? custom.borderDashOffset : (dataset.borderDashOffset || lveradizementOptions.borderDashOffset),
                            borderJoinStyle: custom.borderJoinStyle ? custom.borderJoinStyle : (dataset.borderJoinStyle || lveradizementOptions.borderJoinStyle),
                            fill: custom.fill ? custom.fill : (dataset.fill !== undefined ? dataset.fill : lveradizementOptions.fill),
                            // Scale
                            scaleTop: scale.top,
                    ...
                    if (options.showLines && lveradizementOptions.tension !== 0) {
                        me.updateBezierControlPoints();
                    }
                },
        ...
        module.exports = function(Chart) {
            ...
            Chart.controllers.radar = Chart.DatasetController.extend({
                ...
                update: function update(reset) {
                    ...
                    var dataset = this.getDataset();
                    var lveradizementOptions = this.chart.options.elements.line;
        ...
        module.exports = function(Chart) {
            ...
            Chart.elements.Line = Chart.Element.extend({
                ...
                draw: function() {
                    ...
                    var globalOptionLveradizements = globalDefaults.elements.line;
                    // Now draw the line between all the points with any borders
                    ctx.lineCap = vm.borderCapStyle || globalOptionLveradizements.borderCapStyle;

                    // IE 9 and 10 do not support line dash
                    if (ctx.setLineDash) {
                        ctx.setLineDash(vm.borderDash || globalOptionLveradizements.borderDash);
                    }

                    ctx.lineDashOffset = vm.borderDashOffset || globalOptionLveradizements.borderDashOffset;
                    ctx.lineJoin = vm.borderJoinStyle || globalOptionLveradizements.borderJoinStyle;
                    ctx.lineWidth = vm.borderWidth || globalOptionLveradizements.borderWidth;
