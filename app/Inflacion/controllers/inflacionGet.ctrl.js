...
(function() {
    ...
    app.controller("inflacionGetCtrl", ["$scope", "InflacionService", 'DTOptionsBuilder', inflacionGetCtrl]);

    function inflacionGetCtrl($scope, InflacionService, DTOptionsBuilder) {
        ...
        $scope.exportpdf = function() {
            ...
            docInflacion.text("Unidad de medida y actualización", 280, 60);
