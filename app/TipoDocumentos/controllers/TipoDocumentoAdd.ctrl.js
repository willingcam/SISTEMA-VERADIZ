...
(function() {
    ...
    angular
        .module("veradiz")
        .controller("TipoDocumentoAddCtrl", ['$scope', 'InformesService', 'globalGet', '$state', '$http', TipoDocumentoAddCtrl]);

    function TipoDocumentoAddCtrl($scope, InformesService, globalGet, $state, $http) {
