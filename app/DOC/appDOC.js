...
(function() {
    ...
    angular
        .module("veradizDOC", ['ui.router',
            'LocalStorageModule',
            'datatables',
            'blockUI',
            'veradiz.DOC.services',
            'veradiz.services',
            'veradiz.controllers',
    ...
    function RouterProvider($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            .state("home", {
                url: "/home",
                templateUrl: "app/DOC/home/homeDOC.html",
                controller: 'homeDOCCtrl'
            })
            .state("documentos", {
                url: "/documentos",
                templateUrl: "app/DOC/Documentos/DocumentosGet.html",
                controller: "DocumentosGetCtrl"
            })
            .state("documentosAdd", {
                url: "/documentosAdd",
                templateUrl: "app/DOC/Documentos/DocumentosAdd.html",
                controller: "DocumentosAddCtrl"
            })
            .state("documentosEdit", {
                url: "/documentosEdit/:id",
                templateUrl: "app/DOC/Documentos/DocumentosEdit.html",
