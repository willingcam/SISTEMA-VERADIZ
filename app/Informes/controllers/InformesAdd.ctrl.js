...
(function() {
    ...
    angular
        .module("veradiz")
        .controller("InformesAddCtrl", ['$scope', 'InformesService', 'globalGet', '$state', '$http', 'AuthService', InformesAddCtrl]);

    function InformesAddCtrl($scope, InformesService, globalGet, $state, $http, AuthService) {
                ...
                function(result) {
                    ...
                    if (result.data.records != undefined) {
                        ...
                        InformesService.Add(registo).then(
                            function(result) {
                                toastr.success("Informe registrado exitosamente");
                                $state.go("informes");
                            },
                            function(err) {
                                console.error(err);
